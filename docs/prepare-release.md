...
7. **Open the release PR**: Open a PR to **`main`** titled **`Release vX.Y.Z`** with the approved changelog section as the PR body (include the AI Usage section per [CONTRIBUTING.md](../CONTRIBUTING.md#ai-usage-disclosure)).
